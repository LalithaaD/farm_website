        ...
        <div className="bg-gradient-to-br from-farm-green-50 to-farm-green-100 border-2 border-farm-green-200 rounded-2xl shadow-lg p-6 max-w-sm relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <button
              ...
              className="w-full bg-farm-green-600 hover:bg-farm-green-700 text-white font-serif font-semibold py-3 px-4 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg flex items-center justify-center gap-2"
            >
              Take Me There
      ...
      <div className="fixed bottom-4 left-4 right-4 z-50 md:hidden animate-slide-in-bottom">
        <div className="bg-gradient-to-r from-farm-green-50 to-farm-green-100 border-2 border-farm-green-200 rounded-xl shadow-lg p-4 relative overflow-hidden">
          ...
          <div className="relative z-10 pr-8">
            ...
            <button
              onClick={scrollToNewsletter}
              className="w-full bg-farm-green-600 hover:bg-farm-green-700 text-white font-serif font-semibold py-2 px-4 rounded-lg transition-all duration-300 shadow-md hover:shadow-lg flex items-center justify-center gap-2 text-sm"
            >
              Take Me There
              <ArrowDown className="h-4 w-4" />
            </button>
